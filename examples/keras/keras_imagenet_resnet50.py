...
parser.add_argument('--train_dir', default=os.path.expanduser('/home/ubuntu/imagenet/train'),
                    help='path to training data')
parser.add_argument('--val_dir', default=os.path.expanduser('/home/ubuntu/imagenet/validation'),
