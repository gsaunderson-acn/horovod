...
parser.add_argument('--train_dir', default=os.path.expanduser('~/horovod_gs/examples/keras/imagenet/train'),
                    help='path to training data')
parser.add_argument('--val_dir', default=os.path.expanduser('~/horovod_gs/examples/keras/imagenet/validation'),
